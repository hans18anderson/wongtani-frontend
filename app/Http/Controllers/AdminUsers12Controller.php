<?php namespace App\Http\Controllers;
	...
	class AdminUsers12Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Remember Token","name"=>"remember_token"];
			...
			$this->form[] = ['label'=>'Remember Token','name'=>'remember_token','type'=>'text','validation'=>'min:1|max:255','width'=>'col-sm-10'];
