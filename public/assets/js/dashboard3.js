    ...
    if($('#flotChart1').length) {
      $.plot('#flotChart1', [{
        ...
        yaxis: {
          ...
          ticks: [[0, ''], [15, '2 juta'], [30, '4 juta'], [45, '6 juta'], [60, '8 juta'], [75, '10 juta']],
    ...
    if($('#monthly-sales-chart').length) {
      var monthlySalesChart = document.getElementById('monthly-sales-chart').getContext('2d');
        new Chart(monthlySalesChart, {
          type: 'bar',
          data: {
            labels: ['Kue Cemplon','Keripik Sagu','Kue Bantal','Keripik Tempe','Keripik Pisang'],
            datasets: [{
              label: 'Jumlah (Pack)',
              data: [4580,3487,1438,5734,1972],
