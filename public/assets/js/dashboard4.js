    ...
    if($('#flotChart1').length) {
      $.plot('#flotChart1', [{
        ...
        yaxis: {
          ...
          ticks: [[0, ''], [15, '5000 kg'], [30, '6000 kg'], [45, '7000 kg'], [60, '8000 kg'], [75, '9800 kg']],
        ...
        xaxis: {
          ...
          //'Buah Naga','Jeruk Bali','Jeruk Kerak','Mangga','Alpukat','Bayam','Wortel'
    ...
    if($('#monthly-sales-chart').length) {
      var monthlySalesChart = document.getElementById('monthly-sales-chart').getContext('2d');
        new Chart(monthlySalesChart, {
          type: 'bar',
          data: {
            labels: ['Bukit Raya','Tenayan Raya','Marpoyan Damai','Payung Sekaki','Tampan','Senapelan','Sukajadi'],
            datasets: [{
              label: 'Jumlah pelaku',
              data: [96,24,34,61,78,27,57],
