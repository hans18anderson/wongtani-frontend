...
<div class="row">
  <div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        <h6 class="card-title">Tambah Konsumen</h6>
        <a href="/AdminUser/koncon">Kembali</a>
        <br />
        <br />
        <form action="/AdminUser/konconstore" method="post">
        {{ csrf_field() }}
          <div class="form-group">
            <label for="exampleInputText1">Username</label>
            <input type="text" name="username" class="form-control" id="exampleInputText1" value="" placeholder="Masukkan Username">
          </div>
          <div class="form-group">
            <label for="exampleInputText1">Password</label>
            <input type="password" name="password" class="form-control" id="exampleInputText1" value="" placeholder="Masukkan Password">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" name="no_ktp" class="form-control" id="exampleInputText1" value="" placeholder="Masukkan Nomor KTP">
          </div>
          <div class="form-group">
            <label for="exampleInputText1">Email</label>
            <input type="text" name="email" class="form-control" id="exampleInputText1" value="" placeholder="Masukkan Email">
          </div>
          <div class="form-group">
            <label for="exampleInputText1">Nomor Telepon</label>
            <input type="text" name="no_telp" class="form-control" id="exampleInputText1" value="" placeholder="Masukkan Nomor Telepon">
          </div>
          <div class="form-group">
