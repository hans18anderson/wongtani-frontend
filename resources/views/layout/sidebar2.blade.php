<nav class="sidebar">
  ...
  <div class="sidebar-body">
    <ul class="nav">
      <li class="nav-item nav-category">Pelaku Usaha - {{session('pu_username')}}</li>
      <!--
      <li class="nav-item {{ active_class(['/']) }}">
        <a href="{{ url('/general/admindash') }}" class="nav-link">
     ...
     --> 
      ...
      <li class="nav-item nav-category">Data Profil</li>
      ...
      <!--
      <li class="nav-item {{ active_class(['/']) }}">
      <a href="{{ url('/general/map2') }}" class="nav-link">
...
-->      
      ...
      <li class="nav-item {{ active_class(['/control/tempatusahacon']) }}">
        <a href="{{ url('/control/tempatusahacon') }}" class="nav-link">
          <i class="link-icon" data-feather="home"></i>
          <span class="link-title">Kelola Tempat Usaha</span>
        </a>
      </li>
      
      <li class="nav-item {{ active_class(['/control/brandcon']) }}">
        <a href="{{ url('/control/brandcon') }}" class="nav-link">
          <i class="link-icon" data-feather="feather"></i>
          <span class="link-title">Kelola Brand</span>
        </a>
      </li>
      <li class="nav-item {{ active_class(['/control/brandcon']) }}">
     
      <li class="nav-item {{ active_class(['/control/satuancon']) }}">
        <a href="{{ url('/control/satuancon') }}" class="nav-link">
          <i class="link-icon" data-feather="bar-chart"></i>
          <span class="link-title">Kelola Satuan</span>
        </a>
      </li>
      <li class="nav-item {{ active_class(['/control/produkcon']) }}">
        <a href="{{ url('/control/produkcon') }}" class="nav-link">
          <i class="link-icon" data-feather="gift"></i>
          <span class="link-title">Kelola Produk</span>
        </a>
      </li>
      <li class="nav-item {{ active_class(['/control/kurircon']) }}">
        <a href="{{ url('/control/kurircon') }}" class="nav-link">
          <i class="link-icon" data-feather="truck"></i>
          <span class="link-title">Kelola Kurir</span>
        </a>
      </li>
      <li class="nav-item {{ active_class(['apps/calendar']) }}">
        <a href="{{ url('/control/promosicon') }}" class="nav-link">
          <i class="link-icon" data-feather="droplet"></i>
          <span class="link-title">Kelola Promosi</span>
        </a>
      </li>
      <!--
...
--> 
      <li class="nav-item nav-category">Data Setting</li>
      <li class="nav-item {{ active_class(['/control/pengirimancon']) }}">
        <a href="{{ url('/control/pengirimancon') }}" class="nav-link">
          <i class="link-icon" data-feather="truck"></i>
          <span class="link-title">Kelola Pengiriman</span>
        </a>
      </li>
      <li class="nav-item {{ active_class(['/control/produkjualcon']) }}">
        <a href="{{ url('/control/produkjualcon') }}" class="nav-link">
          <i class="link-icon" data-feather="gift"></i>
          <span class="link-title">Kelola Produk Jual</span>
        </a>
      </li>
      ...
      <li class="nav-item {{ active_class(['advanced-ui/*']) }}">
        <a class="nav-link" data-toggle="collapse" href="#advanced-ui" role="button" aria-expanded="{{ is_active_route(['advanced-ui/*']) }}" aria-controls="advanced-ui">
          <i class="link-icon" data-feather="feather"></i>
          <span class="link-title">Kelola Penjualan</span>
          <i class="link-arrow" data-feather="chevron-down"></i>
        </a>
        <div class="collapse {{ show_class(['advanced-ui/*']) }}" id="advanced-ui">
          <ul class="nav sub-menu">
            <li class="nav-item">
              <a href="{{ url('/control/projualcon') }}" class="nav-link {{ active_class(['advanced-ui/cropper']) }}">Kelola Penjualan Produk</a>
            </li>
            <li class="nav-item">
              <a href="{{ url('/control/penjualanstatuscon') }}" class="nav-link {{ active_class(['advanced-ui/owl-carousel']) }}">Kelola Status</a>
            </li>
          </ul>
        </div>
      </li>
      ...
      <li class="nav-item {{ active_class(['apps/chat']) }}">
        <a href="{{ url('/apps/chat') }}" class="nav-link">
          <i class="link-icon" data-feather="truck"></i>
          <span class="link-title">Laporan Stok</span>
        </a>
      </li>
      <li class="nav-item {{ active_class(['apps/calendar']) }}">
        <a href="{{ url('/apps/calendar') }}" class="nav-link">
