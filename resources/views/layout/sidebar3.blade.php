...
-->
      <li class="nav-item nav-category">Dashboard Pemerintah</li>
      <li class="nav-item {{ active_class(['/general/admindash']) }}">
        <a href="{{ url('/general/pemdash') }}" class="nav-link">
      ...
      <li class="nav-item {{ active_class(['/']) }}">
      <a href="{{ url('/general/map3') }}" class="nav-link">
          <i class="link-icon" data-feather="hash"></i>
