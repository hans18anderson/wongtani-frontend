<nav class="sidebar">
  <div class="sidebar-header">
    <img height="65" width="120" src="{{ asset('/assets/images/logo.jpeg') }}" >
    ...
    <!--
      ...
      <li class="nav-item {{ active_class(['apps/calendar']) }}">
        <a href="{{ url('/apps/calendar') }}" class="nav-link">
          ...
          <span class="link-title">Foto</span>
        </a>
      </li>
      <li class="nav-item {{ active_class(['apps/chat']) }}">
        <a href="{{ url('/apps/chat') }}" class="nav-link">
          <i class="link-icon" data-feather="compass"></i>
          <span class="link-title">Lahan</span>
        </a>
      </li>
      <li class="nav-item {{ active_class(['apps/calendar']) }}">
        <a href="{{ url('/apps/calendar') }}" class="nav-link">
      ...
      <li class="nav-item {{ active_class(['apps/calendar']) }}">
        <a href="{{ url('/apps/calendar') }}" class="nav-link">
          ...
          <span class="link-title">Bahan Perawatan</span>
        </a>
      </li>
      -->
      <!--
      ...
      <li class="nav-item {{ active_class(['advanced-ui/*']) }}">
        <a class="nav-link" data-toggle="collapse" href="#advanced-ui" role="button" aria-expanded="{{ is_active_route(['advanced-ui/*']) }}" aria-controls="advanced-ui">
          ...
          <span class="link-title">Masa Tanam</span>
          <i class="link-arrow" data-feather="chevron-down"></i>
        </a>
      ...
      <li class="nav-item {{ active_class(['advanced-ui/*']) }}">
        <a class="nav-link" data-toggle="collapse" href="#advanced-ui" role="button" aria-expanded="{{ is_active_route(['advanced-ui/*']) }}" aria-controls="advanced-ui">
          ...
          <span class="link-title">Masa Jual</span>
          <i class="link-arrow" data-feather="chevron-down"></i>
        </a>
        <div class="collapse {{ show_class(['advanced-ui/*']) }}" id="advanced-ui">
          <ul class="nav sub-menu">
      ...
      <li class="nav-item {{ active_class(['apps/calendar']) }}">
        <a href="{{ url('/apps/calendar') }}" class="nav-link">
          ...
          <span class="link-title">Laporan Tagihan Penjualan</span>
        </a>
      </li>
...
-->
      <li class="nav-item nav-category">Dashboard Admin</li>
      <li class="nav-item {{ active_class(['/general/addash']) }}">
        <a href="{{ url('/general/addash') }}" class="nav-link">
      ...
      -->
      <li class="nav-item nav-category">Kelola Data Produk</li>
      <li class="nav-item {{ active_class(['/AdminProduk/katprocon']) }}">
      <a href="{{ url('/AdminProduk/katprocon') }}" class="nav-link">
          <i class="link-icon" data-feather="archive"></i>
          <span class="link-title">Kategori Produk</span>
        </a>
      </li>
      <li class="nav-item {{ active_class(['/AdminProduk/subkatprocon']) }}">
      <a href="{{ url('/AdminProduk/subkatprocon') }}" class="nav-link">
          <i class="link-icon" data-feather="archive"></i>
          <span class="link-title">Sub Kategori Produk</span>
        </a>
      </li>
      <li class="nav-item {{ active_class(['/AdminProduk/subsubkatprocon']) }}">
      <a href="{{ url('/AdminProduk/subsubkatprocon') }}" class="nav-link">
          <i class="link-icon" data-feather="archive"></i>
          <span class="link-title">Sub Sub Kategori Produk</span>
        </a>
      </li>

      <li class="nav-item nav-category">Kelola Data User</li>
      <li class="nav-item {{ active_class(['/AdminUser/koncon']) }}">
      <a href="{{ url('/AdminUser/koncon') }}" class="nav-link">
          <i class="link-icon" data-feather="archive"></i>
          <span class="link-title">Konsumen</span>
        </a>
      </li>
      <li class="nav-item {{ active_class(['/control/adminumkmcon']) }}">
      <a href="{{ url('/control/adminumkmcon') }}" class="nav-link">
          <i class="link-icon" data-feather="archive"></i>
          <span class="link-title">Pelaku Usaha</span>
        </a>
      </li>
      <li class="nav-item {{ active_class(['/AdminUser/peluscon']) }}">
      <a href="{{ url('/AdminUser/peluscon') }}" class="nav-link">
          <i class="link-icon" data-feather="archive"></i>
          <span class="link-title">Koordinator Pelaku Usaha</span>
        </a>
      </li>
      <li class="nav-item {{ active_class(['/AdminUser/biduscon']) }}">
      <a href="{{ url('/AdminUser/biduscon') }}" class="nav-link">
          <i class="link-icon" data-feather="archive"></i>
          <span class="link-title">Bidang Usaha</span>
        </a>
      </li>
      <li class="nav-item {{ active_class(['/AdminUser/tempatusahajeniscon']) }}">
        <a href="{{ url('/AdminUser/tempatusahajeniscon') }}" class="nav-link">
          <i class="link-icon" data-feather="archive"></i>
          <span class="link-title">Kelola Jenis Tempat Usaha</span>

      <li class="nav-item nav-category">Kelola Data Wilayah</li>
      <li class="nav-item {{ active_class(['/AdminLokasi/procon']) }}">
      <a href="{{ url('/AdminLokasi/procon') }}" class="nav-link">
          <i class="link-icon" data-feather="archive"></i>
          <span class="link-title">Provinsi</span>
        </a>
      </li>
      <li class="nav-item {{ active_class(['/AdminLokasi/kabkotcon']) }}">
      <a href="{{ url('/AdminLokasi/kabkotcon') }}" class="nav-link">
          <i class="link-icon" data-feather="archive"></i>
          <span class="link-title">Kabupaten Kota</span>
        </a>
      </li>
      <li class="nav-item {{ active_class(['/AdminLokasi/keccon']) }}">
      <a href="{{ url('/AdminLokasi/keccon') }}" class="nav-link">
          <i class="link-icon" data-feather="archive"></i>
          <span class="link-title">Kecamatan</span>
        </a>
      </li>
      <li class="nav-item {{ active_class(['/AdminLokasi/kelcon']) }}">
      <a href="{{ url('/AdminLokasi/kelcon') }}" class="nav-link">
          <i class="link-icon" data-feather="archive"></i>
          <span class="link-title">Kelurahan</span>
        </a>
      </li>
      <li class="nav-item {{ active_class(['/AdminLokasi/lahcon']) }}">
      <a href="{{ url('/AdminLokasi/lahcon') }}" class="nav-link">
          <i class="link-icon" data-feather="archive"></i>
          <span class="link-title">Jenis Lahan</span>
        </a>
      </li>

      <li class="nav-item nav-category">Kelola Transaksi</li>
      <li class="nav-item {{ active_class(['/AdminTransaksi/katpengcon']) }}">
      <a href="{{ url('/AdminTransaksi/katpengcon') }}" class="nav-link">
          <i class="link-icon" data-feather="archive"></i>
          <span class="link-title">Kateogori Pengiriman</span>
        </a>
      </li>
      <li class="nav-item {{ active_class(['']) }}">
      <a href="{{ url('') }}" class="nav-link">
          <i class="link-icon" data-feather="archive"></i>
          <span class="link-title">Status Penjualan</span>
        </a>
      </li>

      <li class="nav-item nav-category">Log Out</li>
      <li class="nav-item">
      <a href="{{ url('/general/log') }}" class="nav-link">
          <i class="link-icon" data-feather="hash"></i>
